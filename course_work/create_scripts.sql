...
-- №2 Определение веса всего заказа
-- №3 Может ли курьер взяться за доставку заказа?

-- Триггеры: --
-- №1 Создание good при добавление request
-- №2 Проверка полного веса заказа
-- №3 Проверка компетенции курьера на доставку заказа
